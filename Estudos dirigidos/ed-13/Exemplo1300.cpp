...
int main(int argc, char **argv) {
    ...
    do {
        ...
        cout << "5 - Testar construtor alternativo com erro" << endl;
        cout << "6 - Testar verificacao de erro" << endl;
        cout << "7 - Testar atribuicoes e tratamento de erro com ponteiros" << endl;
        cout << "8 - Testar construtor de copia" << endl;
        cout << "9 - Testar arranjo de objetos" << endl;
        cout << "10 - Testar arranjo de ponteiros para objetos" << endl;
        // ler do teclado
        cout << endl
