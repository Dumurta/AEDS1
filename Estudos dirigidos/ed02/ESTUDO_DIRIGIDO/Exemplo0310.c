...
--------------------------------------------- testes
        Versao              Teste
         1.0                  01. ( OK )
        Tive problemas com o for(), apresentava erro de pontuação pedindo ; a única solução que encontrei foi copiar o for do exemplo e colar no meu código.
        Apesar de não ser o ideal, funcionou.
